...
public class BitmapCache extends LruCache<String, Bitmap>
{
   ...
   final private Context actvCon;

   private BitmapCache(int maxSize, Context avp)
   {
      super(maxSize);
      actvCon = avp;
   }
    ...
    */
   InputStream getImageContent(String url)
   {
      URL imgUrl;
      InputStream imgContent;

       //12/8/2013; if statement already here, added reference to icon
        if(url.equals(ThumbnailsAdapter.SHOW_LOADING))//special key for returning a loading
        {
            return actvCon.getResources().openRawResource(R.drawable.icon);
        }
